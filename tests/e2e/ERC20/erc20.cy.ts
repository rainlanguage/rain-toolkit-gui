...
describe('ERC20 : Rain Protocol Toolkit', () => {
    ...
    it.skip(`ERC20 : Select ERC20 Tokens from List of All ERC20 Tokens Page`, () => {
        ...
        cy.wait(3000)
        cy.get('div.flex.flex-col.gap-y-3 > div:nth-child(4) > div.flex.flex-row.gap-x-2 > button').click()
        cy.wait(4000)
        cy.contains('button', 'Show').click()
        cy.wait(3000)
        cy.contains('Mintable amount will be 0.0 MyTKN')
    })
    ...
    it.skip(`ERC20 : Select ERC20 Tokens from List of Faucets Page`, () => {
        ...
        cy.wait(1000)
        cy.get('div.flex.flex-col.gap-y-3 > div:nth-child(1) > div.flex.flex-row.gap-x-2 > button').click()
        cy.wait(2000)
        cy.contains('button', 'Show').click()
        cy.wait(2000)
    ...
    it(`ERC20 : Show details of ERC20 Token`, () => {
        cy.get('input').type("0x56f16bc1cd654c51bfc9a601cb1581b65fabfc22")
    ...
    it(`ERC20 : Show details of Faucet`, () => {
        cy.get('input').type("0xd9c0232dcff5acd386473df9960937c9f95a7564")
        cy.contains("Load").click()
        cy.wait(3000)
        cy.contains('button', 'Show').click()
        cy.wait(2000)
