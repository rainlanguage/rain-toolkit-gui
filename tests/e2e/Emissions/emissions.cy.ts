describe('Emissions : Rain Protocol Toolkit', () => {
    beforeEach(() => {
        ...
        cy.get('input').type("0x08430a6667a7a01a05dffff885285e85ec0e18f8") //change input value according to your convenience
    ...
    it("Emission : Claim an Emission", () => {
        ...
        cy.contains('div', '5000.0') // change according to your total supply for that emission
    })
