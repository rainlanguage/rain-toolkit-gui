...
describe('Verify/ VerifyTier : Rain Protocol Toolkit', () => {
    beforeEach(() => {
        ...
        cy.get('input').type("0x848f5408c7057b7e17e3ea796c2544a1f95e90a2")
    ...
    it("Verify : Administer a Verify", () => {
        ...
        cy.get('input').clear().type('0x5A2c9D2ABea0e11cEcE2026D8dECEb2234CB1022')
    ...
    it("Verify : Administer a Verify", () => {
        ...
        // cy.wait(25000)
        cy.get('textarea').clear().type('0x5A2c9D2ABea0e11cEcE2026D8dECEb2234CB1022')
        cy.get('textarea').type('{enter}')
        cy.get('textarea').type('0x973EbeF3889daACBb9bB7f97AbfD4f6e20D26440')
