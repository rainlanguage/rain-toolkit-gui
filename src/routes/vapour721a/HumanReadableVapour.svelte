<script lang="ts">
  ...
  $: humanFriendlySoulbound = HumanFriendlyRead.get(
    soulboundScript, {
      pretty: true,
      storageEnums: [
        'SUPPLY_LIMIT',
  ...
  $: humanFriendlySale = HumanFriendlyRead.get(
    saleScript, {
      pretty: true,
      storageEnums: [
        'SUPPLY_LIMIT',
...
<div class="flex w-full flex-col gap-y-4">
  <div class="flex flex-col justify-between">
    <span class="break-words pt-2 pb-2 whitespace-pre text">
      <span class="text-gray-400">Asset's Human Friendly Readable Soulbound Script:</span><br/>
      {humanFriendlySoulbound}
    </span>
  </div>
  <div class="flex flex-col justify-between">
    <span class="break-words pt-2 pb-2 whitespace-pre text">
      <span class="text-gray-400">Asset's Human Friendly Readable Sale Script:</span><br/>
      {humanFriendlySale}
    </span>
  </div>
</div>